...
# ==================================================================
def fully_unfrozen_training(model, original_model, train_gen, val_gen, home_dir):
    """
    Single phase: Unfreeze ALL layers and train with very small learning rate
    """
    
    print("
" + "="*80)
    print("FULLY UNFROZEN TRAINING")
    print("="*80)
...
Unfreezing ALL layers...")
    ...
    # Compile with very small LR to avoid catastrophic forgetting
    print("
Compiling with LR=1e-5...")
    model.compile(
    ...
    # Callbacks
    log_dir = os.path.join(home_dir, "tensorboard_logs/fully_unfrozen", 
    ...
    callbacks = [
        tf.keras.callbacks.ModelCheckpoint(
            filepath='model_checkpoints/fully_unfrozen-{epoch:02d}-{val_loss:.4f}.keras',
    ...
    print("
" + "="*80)
    print("Training with all layers unfrozen...")
    print("="*80)
    ...
    # Save final model
    model_name = 'gbm_fully_unfrozen.keras'
...
def main():
    print("="*80)
    print("FULLY UNFROZEN + EXTREME IT/LE OVERSAMPLING")
    print("="*80)
    ...
    # Progressive unfreezing
    fully_unfrozen_training(model, original_model, train_gen, val_gen, home_dir)
    
    print("\n" + "="*80)
    print("FULLY UNFROZEN TRAINING COMPLETE")
    print("="*80)
